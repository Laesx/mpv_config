...
mp.add_key_binding("c", "slicing_mark_mp4", toggle_mark)
mp.add_key_binding("a", "slicing_audio_mp4", toggle_audio)
mp.add_key_binding("C", "clear_slicing_mark_mp4", clear_toggle_mark)